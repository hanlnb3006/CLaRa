...
export ADAPTIVE_COMPRESSOR=${ADAPTIVE_COMPRESSOR:-}
export ADAPTIVE_COMPRESSOR_TOP_K=${ADAPTIVE_COMPRESSOR_TOP_K:-}
export ADAPTIVE_COMPRESSOR_STRENGTH=${ADAPTIVE_COMPRESSOR_STRENGTH:-}
export ADAPTIVE_COMPRESSOR_TEMPERATURE=${ADAPTIVE_COMPRESSOR_TEMPERATURE:-}
