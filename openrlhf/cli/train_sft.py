...
def create_clara_config(args: argparse.Namespace) -> CLaRaConfig:
    ...
    return CLaRaConfig(
        ...
        hybrid_adaptive_fusion=args.hybrid_adaptive_fusion,
        hybrid_alpha_min=args.hybrid_alpha_min,
...
def main():
    ...
    print(f"Hybrid retrieval: {args.hybrid_retrieval}")
    if args.hybrid_retrieval:
        fusion = "adaptive" if args.hybrid_adaptive_fusion else "fixed"
        print(f"Hybrid fusion: {fusion}, alpha={args.hybrid_alpha}, "
              f"alpha_range=[{args.hybrid_alpha_min}, {args.hybrid_alpha_max}]")
